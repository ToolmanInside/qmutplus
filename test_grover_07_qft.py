...
class Test_case_00(TestCase):
    def test(self):
        ...
        self.assertTrue(JSDivergence(dist_list[0], result, sample_times) < 0.3)

class Test_case_01(TestCase):
    def test(self):
        result = program(test_case_list[1])
        self.assertTrue(JSDivergence(dist_list[1], result, sample_times) < 0.3)

class Test_case_02(TestCase):
    def test(self):
        result = program(test_case_list[2])
        self.assertTrue(JSDivergence(dist_list[2], result, sample_times) < 0.3)

class Test_case_03(TestCase):
    def test(self):
        result = program(test_case_list[3])
        self.assertTrue(JSDivergence(dist_list[3], result, sample_times) < 0.3)

class Test_case_04(TestCase):
    def test(self):
        result = program(test_case_list[4])
        self.assertTrue(JSDivergence(dist_list[4], result, sample_times) < 0.3)

class Test_case_05(TestCase):
    def test(self):
        result = program(test_case_list[5])
        self.assertTrue(JSDivergence(dist_list[5], result, sample_times) < 0.3)

class Test_case_06(TestCase):
    def test(self):
        result = program(test_case_list[6])
        self.assertTrue(JSDivergence(dist_list[6], result, sample_times) < 0.3)

class Test_case_07(TestCase):
    def test(self):
        result = program(test_case_list[7])
        self.assertTrue(JSDivergence(dist_list[7], result, sample_times) < 0.3)

class Test_case_08(TestCase):
    def test(self):
        result = program(test_case_list[8])
        self.assertTrue(JSDivergence(dist_list[8], result, sample_times) < 0.3)

class Test_case_09(TestCase):
    def test(self):
        result = program(test_case_list[9])
        self.assertTrue(JSDivergence(dist_list[9], result, sample_times) < 0.3)